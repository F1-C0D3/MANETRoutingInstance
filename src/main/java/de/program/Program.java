...
//		tTopoogy.create();
		...
		Node<EdgeDistance> source1 = manet.getVertex(0);
		Node<EdgeDistance> target1 = manet.getVertex(120);

		Node<EdgeDistance> source2 = manet.getVertex(0);
		Node<EdgeDistance> target2 = manet.getVertex(4);
//
//		Node<EdgeDistance> source3 = manet.getVertex(0);
...
//		Node<EdgeDistance> target6 = manet.getVertex(22);
		...
		Flow<Node<EdgeDistance>, Link<EdgeDistance>, EdgeDistance> f2 = new Flow<Node<EdgeDistance>, Link<EdgeDistance>, EdgeDistance>(
				source2, target2, new DataRate(4.00d, Unit.Type.megabit));
//
...
//		flowsGP.add(fGP5);
//		flowsGP.add(fGP6);
		GeneticOptimization go = new GeneticOptimization(manet, flowsGP, 60000, 3);
